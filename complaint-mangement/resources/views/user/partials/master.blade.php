          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Booked Services</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('user.complain.index') }}" class="menu-link">
                    <div data-i18n="Without menu">All Booked service list</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('user.complain.create') }}" class="menu-link">
                    <div data-i18n="Without navbar">Make Appointment</div>
                  </a>
                </li>
              </ul>
            </li>   
        ...
        <div class="layout-page">
          ...
          <nav
            ...
            <div class="col-12 col-sm-6">
              <h3 class="header">Welcome to User Panel</h3>
            </div>
