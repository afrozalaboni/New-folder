          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="{{ route('admin.dashboard') }}" class="menu-link">
                ...
                <div class=" comp" data-i18n="Analytics">Dashboard</div>
              </a>
            </li>
            ...
            <li class="menu-item ">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class=" comp" data-i18n="Layouts">Service Category</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('admin.category.index') }}" class="menu-link">
                    <div class=" comp" data-i18n="Without menu">All Category</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('admin.category.create') }}" class="menu-link">
                    <div class=" comp"data-i18n="Without navbar">Add Category</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item ">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-category"></i>
                <div class=" comp" data-i18n="Layouts">Service Details</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('admin.service.index') }}" class="menu-link">
                    <div class=" comp" data-i18n="Without menu">All Service details</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('admin.service.create') }}" class="menu-link">
                    <div class=" comp"data-i18n="Without navbar">Add Service details</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class=" comp"data-i18n="Layouts">Technician</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('admin.technician.list') }}" class="menu-link">
                    <div class=" comp"data-i18n="Without menu">All Technician</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div class=" comp" data-i18n="Layouts">User</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('admin.user.list') }}" class="menu-link">
                    <div class=" comp"data-i18n="Without menu">All User</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
              <a href="{{ route('admin.contact') }}" class="menu-link">
                ...
                <div class=" comp"data-i18n="Analytics">Contact List</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('admin.complaint') }}" class="menu-link">
                <i class="menu-icon fa-solid fa-list"></i>
                <div class=" comp"data-i18n="Analytics">Appointment List</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon fa-solid fa-list"></i>
                <div class=" comp"data-i18n="Layouts">Reports</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('admin.report.inreport')}}" class="menu-link">
                    <div class=" comp"data-i18n="Without menu">Invoice Report</div>
                  </a>
                </li>
